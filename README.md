...
| --------- | ------------------------------------ |
| OPENLIB   | ライブラリー一覧を開く                          |
| OPENOBJ   | 指定したライブラリー内のオブジェクト一覧を開く              |
| OPENMBR   | 指定したオブジェクト内のメンバー一覧を開く                |
| CODEMBR   | 指定したメンバーを VS Code で開く                |
| SAVEMBR   | 編集したメンバーを IBM i に保存する                |
| CPYSRC    | ソースオブジェクトを指定したライブラリー配下にコピーする（初回のみ使用） |
| CPYMBR    | メンバーを指定したオブジェクト配下にコピーする              |
| CRTRPG    | RPGLE ソースをコンパイルする                    |
| CRTSQLRPG | SQLRPGLE ソースをコンパイルする                 |
| CRTPF     | PF ソースをコンパイルする                       |
| CALLPGM   | プログラムを実行する                           |
| DEPLOYMBR | メンバーを指定したオブジェクト配下にデプロイする             |
| DEPLOYOBJ | オブジェクトを指定したライブラリー配下にデプロイする           |
